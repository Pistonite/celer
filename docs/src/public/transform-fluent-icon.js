...
elements.forEach(function(e) {
    ...
    var name = icon.substring(0, si).replace(/([A-Z])/g, " $1").trim();
    ...
    var url = `https://raw.githubusercontent.com/microsoft/fluentui-system-icons/main/assets/${encodeURIComponent(name)}/SVG/${file}.svg`;
    fetch(url)
