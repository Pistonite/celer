...
import { FsErr, FsResult, FsVoid, fsErr } from "../error";
import { fsNormalize } from "../path";
...
export class FsImplF implements FsFileSystemUninit, FsFileSystem, FsFileSystemInternal {
    public root: string;
