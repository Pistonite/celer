...
export const EditorSettings: React.FC = () => {
    ...
    const { showFileTree, autoSaveEnabled, autoLoadEnabled, deactivateAutoLoadAfterMinutes } = useSelector(settingsSelector);
    const { setShowFileTree, setAutoSaveEnabled, setAutoLoadEnabled, setDeactivateAutoLoadAfterMinutes } = useActions(settingsActions);
        ...
        <>
            ...
            <SettingsSection title="Save">
                <Field
                    ...
                    validationMessage={supportsSave ? undefined : "Saving is not supported by your browser."}
                >
                    <Switch
            ...
            <SettingsSection title="Load">
                ...
                >
                    <Dropdown
                        ...
                        value={deactivateAutoLoadAfterMinutes > 0 ? `${deactivateAutoLoadAfterMinutes} minutes` : "Never"}
                        selectedOptions={[deactivateAutoLoadAfterMinutes.toString()]}
                        onOptionSelect={(_, data) => {
                            setDeactivateAutoLoadAfterMinutes(parseInt(data.optionValue ?? "-1") || -1);
                        }}
                    >
                        {
