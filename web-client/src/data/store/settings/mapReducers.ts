...
export const setLineSectionMode: ReducerDeclWithPayload<MapSettings, SectionMode> =
...
export const setFadeNonCurrentLayerLines: ReducerDeclWithPayload<MapSettings, boolean> =
    withPayload((state: MapSettings, value: boolean) => {
        state.fadeNonCurrentLayerLines = value;
    });

/// Set the current icon section mode
export const setIconSectionMode: ReducerDeclWithPayload<MapSettings, SectionMode> =
    withPayload((state: MapSettings, value: SectionMode) => {
...
export const setFadeNonCurrentLayerIcons: ReducerDeclWithPayload<MapSettings, boolean> =
    withPayload((state: MapSettings, value: boolean) => {
        state.fadeNonCurrentLayerIcons = value;
    });

/// Set the current marker section mode
export const setMarkerSectionMode: ReducerDeclWithPayload<MapSettings, SectionMode> =
    withPayload((state: MapSettings, value: SectionMode) => {
        state.markerSectionMode = value;
    });

/// Set the current marker layer mode
export const setMarkerLayerMode: ReducerDeclWithPayload<MapSettings, LayerMode> =
    withPayload((state: MapSettings, value: LayerMode) => {
        state.markerLayerMode = value;
    });

/// Set if markers not on current layer should fade
export const setFadeNonCurrentLayerMarkers: ReducerDeclWithPayload<MapSettings, boolean> =
    withPayload((state: MapSettings, value: boolean) => {
        state.fadeNonCurrentLayerMarkers = value;
    });

/// Set primary icon size
export const setPrimaryIconSize: ReducerDeclWithPayload<MapSettings, VisualSize> =
    withPayload((state: MapSettings, value: VisualSize) => {
        state.primaryIconSize = value;
    });

/// Set secondary icon size
export const setSecondaryIconSize: ReducerDeclWithPayload<MapSettings, VisualSize> =
    withPayload((state: MapSettings, value: VisualSize) => {
