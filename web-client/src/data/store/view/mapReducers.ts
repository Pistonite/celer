...
import { MapViewStore, MapView } from "./map";

/// Set the current map layer
export const setMapLayer: ReducerDeclWithPayload<MapViewStore, number> =
...
export const setMapZoom: ReducerDeclWithPayload<MapViewStore, number> =
    withPayload((state: MapViewStore, value: number) => {
