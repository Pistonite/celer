...
import { Reducer, createSlice, SliceCaseReducers, CreateSliceOptions, Draft } from "@reduxjs/toolkit";
...
type ReducerEffect<S, P=undefined> = P extends undefined ? ReducerDecl<S> : (state: Draft<S>, payload: P) => void;
