...
export const setLineLayerMode = withPayload<MapSettingsState, LayerMode>(
    (state, value) => {
...
export const setFadeNonCurrentLayerLines = withPayload<
    MapSettingsState,
    boolean
>((state, value) => {
...
export const setIconSectionMode = withPayload<MapSettingsState, SectionMode>(
    (state, value) => {
...
export const setIconLayerMode = withPayload<MapSettingsState, LayerMode>(
    (state, value) => {
...
export const setFadeNonCurrentLayerIcons = withPayload<
    MapSettingsState,
    boolean
>((state, value) => {
...
export const setMarkerSectionMode = withPayload<MapSettingsState, SectionMode>(
    (state, value) => {
...
export const setMarkerLayerMode = withPayload<MapSettingsState, LayerMode>(
    (state, value) => {
...
export const setFadeNonCurrentLayerMarkers = withPayload<
    MapSettingsState,
    boolean
>((state, value) => {
...
export const setPrimaryIconSize = withPayload<MapSettingsState, VisualSize>(
    (state, value) => {
...
export const setSecondaryIconSize = withPayload<MapSettingsState, VisualSize>(
    (state, value) => {
...
/// Set other icon size
export const setOtherIconSize = withPayload<MapSettingsState, VisualSize>(
    (state, value) => {
...
export const setLineSize = withPayload<MapSettingsState, VisualSize>(
    (state, value) => {
...
/// Set arrow size
export const setArrowSize = withPayload<MapSettingsState, VisualSize>(
    (state, value) => {
...
/// Set arrow frequency
export const setArrowFrequency = withPayload<MapSettingsState, VisualSize>(
    (state, value) => {
...
/// Set marker size
export const setMarkerSize = withPayload<MapSettingsState, VisualSize>(
    (state, value) => {
