...
export const setShowFileTree = withPayload<EditorSettingsState, boolean>((state, showFileTree) => {
    state.showFileTree = showFileTree;
});

/// Set if auto load is enabled
export const setAutoLoadEnabled= withPayload<
    EditorSettingsState,
    boolean
...
export const setAutoSaveEnabled= withPayload<
    EditorSettingsState,
    boolean
