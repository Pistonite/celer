...
export class Kernel {
    ...
    // /// Show a rich alert dialog with a custom component as the body
    // public showRichAlert(
    //     title: string,
    //     okButton: string,
    //     cancelButton: string,
    ...
    // private setAlertCallback(resolve: (ok: boolean | string) => void) {
    ...
    // }
    //
    // public getRichAlertComponent(): React.ComponentType | undefined {
