...
impl TempStr {
    ...
    pub fn hydrate<S>(&self, args: &[S]) -> String where S: AsRef<str> {
...
mod ut {
    ...
    fn test_only_literal() {
        ...
        assert_eq!(TempStr::from("abcd").hydrate(&["hello".to_string()]), "abcd");
    ...
    fn test_mixed() {
        ...
        assert_eq!(TempStr::from("bar$(2)foo$(1)").hydrate(args), "bartempfooworld");
        assert_eq!(TempStr::from("bar$(3)$(3) $(2)$(1)$(2)").hydrate(args), "bar tempworldtemp");
    }
}
